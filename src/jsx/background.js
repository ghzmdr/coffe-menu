var camera, scene, renderer,
    geometry, material, mesh, clock, cubeSineDriver, delta, light,
    smokeTexture, smokeMaterial, smokeGeo, smokeParticles;
...
function init() {
    ...
    smokeMaterial = new THREE.MeshLambertMaterial({color: 0xe0e2e5, map: smokeTexture, transparent: true});
